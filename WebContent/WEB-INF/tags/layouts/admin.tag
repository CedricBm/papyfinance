  ...
  <nav class="light-blue lighten-1" role="navigation">
    <div class="nav-wrapper container">
      ...
      <ul class="right hide-on-med-and-down">
        <li><a class="waves-effect waves-light" href="admin/search/company_member">Rechercher tous les membres societe</a></li>
        <li><a class="waves-effect waves-light" href="admin/search/invest">Rechercher tous les investisseurs</a></li>
      </ul>
