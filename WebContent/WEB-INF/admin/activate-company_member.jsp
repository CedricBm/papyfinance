...
<layout:admin pageTitle="Activation compte">
  <div class="col s12">
    ...
    <input id="role" type="text" name="role" value="company-member" style="display:none" />
      ...
      <div class="row">
        <div class="input-field col s12">
          <i class="material-icons prefix">account_circle</i> <input id="password" name="password" type="password" class="validate" required aria-required="true"> <label for="password">Mot de passe</label>
        </div>
      </div>
      <div class="row">
