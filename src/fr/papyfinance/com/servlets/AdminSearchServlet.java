...
public class AdminSearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
		case 1: this.getServletContext().getRequestDispatcher("/WEB-INF/admin/search-companies.jsp").forward(request,
				response);
		break;
		case 2: this.getServletContext().getRequestDispatcher("/WEB-INF/admin/search-users.jsp").forward(request,
				response);
		break;
		case 3: this.getServletContext().getRequestDispatcher("/WEB-INF/admin/search-offers.jsp").forward(request,
				response);
		break;
		case 4: this.getServletContext().getRequestDispatcher("/WEB-INF/admin/search-transactions.jsp").forward(request,
				response);
		break;
			default : this.getServletContext().getRequestDispatcher("/WEB-INF/admin/search.jsp").forward(request,
					response);
				break;
		}
